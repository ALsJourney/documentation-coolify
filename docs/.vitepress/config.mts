...
export default defineConfig({
  ...
  themeConfig: {
    ...
    nav: [
      { text: 'Basics', link: '/get-started/introduction', activeMatch: '^/(get-started|builds|applications|databases|integrations|knowledge-base|api-reference|troubleshoot)/' },
      { text: 'Services', link: '/services/overview', activeMatch: '/services/' },
      ...
      '/services/': [
        {
          ...
          items: [
            ...
            { text: 'CodiMD', link: '/services/codimd' },
            ...
            { text: 'FoundryVTT', link: '/services/foundryvtt' },
            ...
            { text: 'Grist', link: '/services/grist' },
            ...
            { text: 'Marimo', link: '/services/marimo' },
            ...
            { text: 'Memos', link: '/services/memos' },
            ...
            { text: 'Passbolt', link: '/services/passbolt' },
            { text: 'Paymenter', link: '/services/paymenter' },
            { text: 'Penpot', link: '/services/penpot' },
            { text: 'PgBackWeb', link: '/services/pgbackweb' },
            ...
            { text: 'Pterodactyl', link: '/services/pterodactyl' },
            ...
            { text: 'Ryot', link: '/services/ryot' },
            { text: 'Seafile', link: '/services/seafile' },
            ...
            { text: 'Soketi App Manager', link: '/services/soketi-app-manager' },
            ...
            { text: 'Typesense', link: '/services/typesense' },
            ...
            { text: 'Vert', link: '/services/vert' },
            { text: 'Vikunja', link: '/services/vikunja' },
            { text: 'VVVEB', link: '/services/vvveb' },
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            collapsed: true,
            items: [
              { text: 'File Mount Errors', link: '/troubleshoot/persistent-storage/file-mount-errors' },
            ]
          },
        ],
      },
